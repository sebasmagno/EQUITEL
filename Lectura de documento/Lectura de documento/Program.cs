            ...
            try
            {
                ...
                foreach (var parrafo in parrofos)
                {
                    ...
                    foreach (var palabra in palabras)
                    {
                        ...
                        if (rg.IsMatch(palabra))
                        {
                            letrasN = Regex.Matches(palabra.ToUpper(), "N").Count;
                           
                            contador += (palabra.Length - letrasN);
                        }
                    }
                }
                guardarMensaje($"Cantidad de caracteres sin incluir la letra N: {contador}");
                Console.WriteLine($"Cantidad de caracteres sin incluir la letra N: {contador}");
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                foreach (var parrafo in parrofos)
                {
                    ...
                    foreach (var palabra in palabras)
                    {
                        ...
                        {
                            // Se validad todas las palabras que terminen en n, si la ultima letra es "." se valida la posicion anterior
